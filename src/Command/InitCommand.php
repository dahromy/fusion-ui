    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $fusionUIDirectives = <<<EOF
            ...
            @font-face {
                ...
                src: url("@dahromy/fusion-ui/styles/fonts/geist-sans/Geist-Variable.woff2") format("woff2");
                font-display: swap;
                font-weight: 100 900
            }
            ...
            @font-face {
                ...
                src: url("@dahromy/fusion-ui/styles/fonts/geist-mono/GeistMono-Variable.woff2") format("woff2");
                font-display: swap;
                font-weight: 100 900
            }
